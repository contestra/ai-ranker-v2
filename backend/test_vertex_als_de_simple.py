#!/usr/bin/env python3
"""Test Vertex with ALS for Germany (DE) - both ungrounded and grounded via router."""
...
async def test_vertex_with_als():
    ...
    print("=" * 80)
    print("TEST 1: VERTEX UNGROUNDED with ALS=DE (via Router)")
    print("=" * 80)
    ...
    print("\n" + "=" * 80)
    print("TEST 2: VERTEX GROUNDED with ALS=DE (via Router)")
    print("=" * 80)
    print(f"Prompt: {base_request['messages'][0]['content']}")
    print(f"ALS Country: {als_context_dict['country_code']}")
    print(f"ALS Locale: {als_context_dict['locale']}")
