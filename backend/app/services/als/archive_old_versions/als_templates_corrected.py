...
class ALSTemplates:
    ...
    TEMPLATES: Dict[str, CountryTemplate] = {
        ...
        "AE": CountryTemplate(
            ...
            formatting_example="Dubai P.O. Box • +971 4 xxx xxxx • AED 49.00",
            weather_stub_local="national weather service: Dubai",
            notes=[
        ...
        "FR": CountryTemplate(
            ...
            utc_offsets={"summer": "+02:00", "winter": "+01:00"},
            civic_keyword="service-public.fr",
            phrases=[
    ...
    def render_block(
        ...
        header = {
            ...
            "AE": "Ambient Context (localization only; do not cite):",
